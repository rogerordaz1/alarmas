    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form class="pb-5" action="{{ route('servicios.update' , $servicio) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="password">Activo</label>
                            <input type="checkbox" name="activo" id="activo" {{ $servicio->activo == 1  ? 'checked' : ''}}>
                        </div>
