                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
                            <div
                                ...
                                <p class="d-block text-white">Alarmas</p>
                                <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="fw-semibold">
                                            {{ isset($resultados[$user->id]) ? $resultados[$user->id] . ' min' : 'N/A' }}
                                        </div>
                    ...
                    @foreach ($alarmas as $key => $item)
                        @if ($key < 4)
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    class="card mb-4 text-white {{ $item->estado->estado == 'Bien' ? 'bg-primary' : 'bg-danger' }}">
